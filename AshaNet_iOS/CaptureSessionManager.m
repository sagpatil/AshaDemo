...
- (void)captureStillImageWithOverlay:(UIImage*)overlay
{
	...
	[[self stillImageOutput] captureStillImageAsynchronouslyFromConnection:videoConnection
                                                         completionHandler:^(CMSampleBufferRef imageSampleBuffer, NSError *error) {
                                                             ...
                                                             UIImage *processedImage = [self cropImage:image toSize:CGSizeMake(320, 568) circular:NO];
                                                             [processedImage drawInRect:CGRectMake(0, 0,320, 568)];
                                                             [overlay drawInRect:CGRectMake(0, 0,320, 568)];
